...
module.exports = {
  ...
  async execute(client, interaction) {
    if (interaction.user.id !== "564327207133249536") {
      await interaction.reply("Only `bhaalu` can use this command.");
      return;
    }

    const botOwner = client.users.cache.get("564327207133249536");
