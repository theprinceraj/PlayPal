...
exports.run = async (client, message, args) => {
    ...
    GlobalFonts.registerFromPath(join(__dirname,'igFont.ttf'),'igFont');

    const image = await loadImage(join(__dirname, 'igTemplate.jpg'))
...
exports.name = 'igfake'
exports.aliases = ['ig','influencer','chhapri','chapri','instagram']